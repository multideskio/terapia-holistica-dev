    ...
    <table align="center" width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #444444; border-radius: 8px; padding: 20px;">
        ...
        <tr>
            <td style="padding: 20px;">
                ...
                <p style="margin: 0;">
                    <a href="<?= site_url() ?>" style="display: inline-block; padding: 10px 20px; font-size: 16px; color: #FFFFFF; background-color: #1E90FF; text-decoration: none; border-radius: 5px; text-align: center;">Acessar Minha Conta</a>
                </p>
