    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= site_url('dashboard/ts/home') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= site_url('dashboard/ts/file-manager') ?>">
...
-->
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?= site_url('dashboard/ts/history') ?>">
