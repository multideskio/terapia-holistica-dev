    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#wizardAccordion">
        <div class="accordion-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control required-field" id="name" name="name" disabled autocomplete="off">
                <div class="invalid-feedback">Este campo é obrigatório.</div>
            </div>
            <div class="mb-3">
                <label for="birthDate" class="form-label">Data de nascimento:</label>
                <input type="date" class="form-control required-field" id="birthDate" name="birthDate" disabled autocomplete="off">
                <div class="invalid-feedback">Este campo é obrigatório.</div>
